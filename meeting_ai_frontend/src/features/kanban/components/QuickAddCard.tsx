  ...
  if (!open) {
    return (
      <button
        ...
        className="w-full text-left text-[11px] font-semibold uppercase tracking-wider text-slate-400 hover:text-indigo-600 hover:bg-canvas rounded px-2 py-1.5 flex items-center gap-1.5 transition-colors"
      >
