# Codex instructions — agentic-meeting-assistant

**Before doing anything on this repo, read `.Codex/HANDOUT.md`.**
...
running session log, and the open threads. It is maintained by Codex.
